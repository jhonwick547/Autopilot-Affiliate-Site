...
from .site_config import PUBLIC, PUBLIC_POSTS, TEMPLATES, SITE_BASE_URL, SITE_NAME, BASE_PATH
...
def render_index(posts_info: list):
    ...
    html = index_tpl.render(site_name=SITE_NAME, posts=posts_info, base_path=BASE_PATH)
